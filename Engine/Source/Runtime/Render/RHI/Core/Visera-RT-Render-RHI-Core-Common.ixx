...
export module Visera.Runtime.Render.RHI.Core:Common;
#define VE_MODULE_NAME "RHI.Core:Common"

export namespace VE
{
	// VE_ENUM_CLASS(EVkCullMode,               VkCullModeFlagBits)
	// VE_ENUM_CLASS(EVkColorSpace,				VkColorSpaceKHR)
	// VE_ENUM_CLASS(EVkBorderColor,			VkBorderColor)
	// VE_ENUM_CLASS(EVkSamplerMimapMode,		VkSamplerMipmapMode)
	// VE_ENUM_CLASS(EVkSamplerAddressMode,		VkSamplerAddressMode)
	// VE_ENUM_CLASS(EVkTransferPipelineStage,	VkPipelineStageFlags)
	// VE_ENUM_CLASS(EVkComputePipelineStage,	VkPipelineStageFlags)
	// VE_ENUM_CLASS(EVkFilter,			VkFilter)
	// VE_ENUM_CLASS(EVkSharingMode,	VkSharingMode)
	// VE_ENUM_CLASS(EVkSwizzle,		VkComponentSwizzle)
	// VE_ENUM_CLASS(EVkImageViewType,	VkImageViewType)
	// VE_ENUM_CLASS(EVkImageType,		VkImageType)
	// VE_ENUM_CLASS(EVkImageAspect,	VkImageAspectFlags)
	// VE_ENUM_CLASS(EVkImageTiling,	VkImageTiling)
	// VE_ENUM_CLASS(EVkFormat,			VkFormat)
	// VE_ENUM_CLASS(EVkPresentMode,	VkPresentModeKHR)
	// VE_ENUM_CLASS(EVkDescriptorType,	VkDescriptorType)
	// VE_ENUM_CLASS(EVkQueueFamily,	UInt32)
	// VE_ENUM_CLASS(EVkCommandPoolType,VkCommandPoolCreateFlags)
	// VE_ENUM_CLASS(EVkCommandLevel,	VkCommandBufferLevel)
	// VE_ENUM_CLASS(EVkSampleRate,		VkSampleCountFlags)
	// VE_ENUM_CLASS(EVkAccess,			VkAccessFlags)
	// VE_ENUM_CLASS(EVkShaderStage,	VkShaderStageFlags)
	// VE_ENUM_CLASS(EVkGraphicsPipelineStage,	VkPipelineStageFlags)
	// VE_ENUM_CLASS(EVkMemoryUsage,	VmaMemoryUsage)
	// VE_ENUM_CLASS(EVkImageLayout,	VkImageLayout)
	// VE_ENUM_CLASS(EVkImageUsage,		VkImageUsageFlags)
	// VE_ENUM_CLASS(EVkBufferUsage,	VkBufferUsageFlags)
	// VE_ENUM_CLASS(EVkAttachmentIO,	VkAttachmentLoadOp)

	// struct	FVkComponentMapping
	// using	FVkExtent2D		= VkExtent2D;
	// using	FVkExtent3D		= VkExtent3D;
	// using	FVkOffset2D		= VkOffset2D;
	// using	FVkOffset3D		= VkOffset3D;
	// using	FVkRenderArea	= VkRect2D;
	...
	VE_ENUM_CLASS(EVkSamplerMipmapMode, VkSamplerMipmapMode)
	{
		Nearest = VK_SAMPLER_MIPMAP_MODE_NEAREST,
		Linear  = VK_SAMPLER_MIPMAP_MODE_LINEAR,
	};

	VE_ENUM_CLASS(EVkCompareOp, VkCompareOp)
	{
	...
	VE_ENUM_CLASS(EVkPipelineBindPoint, VkPipelineBindPoint)
	{
	...
	VE_ENUM_CLASS(EVkSampleRate, VkSampleCountFlagBits)
	{
	...
	struct FVkSwizzle
	{
		EVkSwizzle R = EVkSwizzle::Identity;
		EVkSwizzle G = EVkSwizzle::Identity;
		EVkSwizzle B = EVkSwizzle::Identity;
		EVkSwizzle A = EVkSwizzle::Identity;
	};
