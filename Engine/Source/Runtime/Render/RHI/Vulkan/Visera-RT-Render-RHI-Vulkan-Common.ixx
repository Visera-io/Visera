...
export module Visera.Runtime.Render.RHI.Vulkan.Common;
...
export namespace VE
{
	...
	VE_ENUM_CLASS(EVulkanBorderColor, VkBorderColor)
	{
		Black_Float			= VK_BORDER_COLOR_FLOAT_OPAQUE_BLACK,
		Black_Int			= VK_BORDER_COLOR_INT_OPAQUE_BLACK,

		White_Float			= VK_BORDER_COLOR_FLOAT_OPAQUE_WHITE,
		White_Int			= VK_BORDER_COLOR_INT_OPAQUE_WHITE,

		BlackAlpha_Int		= VK_BORDER_COLOR_INT_TRANSPARENT_BLACK,
		BlackAlpha_Float	= VK_BORDER_COLOR_FLOAT_TRANSPARENT_BLACK,

		Custom_Int			= VK_BORDER_COLOR_INT_CUSTOM_EXT,
		Custom_Float		= VK_BORDER_COLOR_FLOAT_CUSTOM_EXT,
	};

	VE_ENUM_CLASS(EVulkanSamplerMipmapMode, VkSamplerMipmapMode)
	{
		Nearest = VK_SAMPLER_MIPMAP_MODE_NEAREST,
		Linear  = VK_SAMPLER_MIPMAP_MODE_LINEAR,
	};

	VE_ENUM_CLASS(EVulkanCompareOp, VkCompareOp)
	{
	...
	VE_ENUM_CLASS(EVulkanFormat, VkFormat)
	{
		...
		// S24_Integer_B8_G8_R8	= VK_FORMAT_B8G8R8_SINT,
		// U24_sRGB_B8_G8_R8		= VK_FORMAT_B8G8R8_SRGB,
		...
		// 96Bits Formats
		U96_Integer_R32_G32_B32 = VK_FORMAT_R32G32B32_UINT,
		S96_Integer_R32_G32_B32 = VK_FORMAT_R32G32B32_SINT,
		S96_Float_R32_G32_B32   = VK_FORMAT_R32G32B32_SFLOAT,
		...
		Vertex3F = S96_Float_R32_G32_B32,
	};
	...
	VE_ENUM_CLASS(EVulkanBufferUsage, VkBufferUsageFlags)
	{
		...
		SharedDeviceAddress	= VK_BUFFER_USAGE_SHADER_DEVICE_ADDRESS_BIT,
	};
